...
/// </summary>
public static class BookClipConfiguration
{
    ...
    static BookClipConfiguration()
    {
        cartPersistDays = Int32.Parse(ConfigurationManager.AppSettings["CartPersistDays"]);
        dbConnectionString = ConfigurationManager.ConnectionStrings["BookClipConnectionString"].ConnectionString;
        dbProviderName = ConfigurationManager.ConnectionStrings["BookClipConnectionString"].ProviderName;
