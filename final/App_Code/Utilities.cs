...
public static class Utilities
{
    ...
    public static void SendMail(string from, string to, string subject, string body)
    {
        ...
        SmtpClient mailClient = new SmtpClient(BookClipConfiguration.MailServer);
    ...
    public static void LogError(Exception ex)
    {
        ...
        if (BookClipConfiguration.EnableErrorLogEmail)
        {
            string from = "iloy1004ca@gmail.com";
            string to = BookClipConfiguration.ErrorLogEmail;
            string subject = BookClipConfiguration.SiteName + " error report";
